    ...
    useEffect(() => {
        const fetchItems = async () => {
            try {
                ...
                if (filters.category.length) query.append("category", filters.category.join(","));
                ...
                const res = await apiRequest.get(`/api/items/search?${query.toString()}`);
        ...
        <div className="itemlist">
            ...
            <div className="cards">
                <div className="search">
                    ...
                    <div className="box" onClick={() => setItems([...items].sort((a, b) => a.name.localeCompare(b.name)))}>
                        <RiSortAlphabetAsc />
                    </div>

                    <div className="box" onClick={() => setItems([...items].sort((b, a) => a.name.localeCompare(b.name)))}>
                        <RiSortAlphabetDesc />
                    </div>
                </div>
